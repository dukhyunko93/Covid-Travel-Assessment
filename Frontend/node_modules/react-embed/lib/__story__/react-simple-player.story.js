...
react_1.storiesOf('react-simple-player/format', module)
    .add('.mp3', function () {
    return React.createElement(__1.default, { url: 'https://file-examples.com/wp-content/uploads/2017/11/file_example_MP3_700KB.mp3' });
})
    .add('.wav', function () {
    return React.createElement(__1.default, { url: 'https://file-examples.com/wp-content/uploads/2017/11/file_example_WAV_1MG.wav' });
})
    .add('.aac', function () {
...
react_1.storiesOf('react-simple-player/widths', module)
    .add('300px', function () {
    return (React.createElement("div", { style: { width: 300 } },
        React.createElement(__1.default, { url: 'https://file-examples.com/wp-content/uploads/2017/11/file_example_MP3_700KB.mp3', width: 300 })));
})
    .add('500px', function () {
    return (React.createElement("div", { style: { width: 500 } },
        React.createElement(__1.default, { url: 'https://file-examples.com/wp-content/uploads/2017/11/file_example_MP3_700KB.mp3', width: 500 })));
});
react_1.storiesOf('react-simple-player', module).add('dark mode', function () {
    return React.createElement(__1.default, { isDark: true, url: 'https://file-examples.com/wp-content/uploads/2017/11/file_example_MP3_700KB.mp3' });
});
