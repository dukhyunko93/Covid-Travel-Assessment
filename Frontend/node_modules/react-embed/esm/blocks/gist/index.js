...
var Gist = (function (_super) {
    ...
    Gist.prototype._updateIframeContent = function () {
        ...
        var resizeScript = "onload=\"parent.document.getElementById('" + this.id + "').style.height=document.body.scrollHeight + 'px'\"";
        var iframeHtml = "<html><head><base target=\"_parent\">" + styles + "</head><body style=\"margin:0\" " + resizeScript + ">" + gistScript + "</body></html>";
        doc.open();
    ...
    Gist.prototype.render = function () {
        ...
        return renderWrap(React.createElement("iframe", { id: this.id, ref: function (n) {
                _this.iframeNode = n;
            }, width: "100%", frameBorder: 0, style: { margin: "0 0 -" + fontSize + "px" } }));
    };
    return Gist;
}(React.PureComponent));
export default Gist;
